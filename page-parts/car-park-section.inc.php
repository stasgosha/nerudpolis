<section class="car-park-section section-default-bottom-padding">
	<div class="container">
			...
			<div class="section-content">
				...
				<div class="features-list">
					<div class="item">
						...
						<div class="item-text">Аренда спецтехники</div>
					</div>
					<div class="item">
						<div class="item-icon">
							<i class="icon-snowflake"></i>
						</div>
						<div class="item-text">Вывоз снега</div>
					</div>
					<div class="item">
						<div class="item-icon">
							<i class="icon-ground"></i>
						</div>
						<div class="item-text">Вывоз грунта</div>
					</div>
				</div>
			</div>
